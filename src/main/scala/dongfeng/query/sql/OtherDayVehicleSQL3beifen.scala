...
object OtherDayVehicleSQL3beifen {
  ...
  lazy val driver_online_record_time_original =
    """
      ...
      |where DATEDIFF(from_unixtime(unix_timestamp(),'yyyy-MM-dd'),TO_DATE(createTime)) = 21
    """.stripMargin
  ...
  lazy val order_info_filter =
    """
      ...
      |) tb
      |where
      |DATEDIFF(from_unixtime(unix_timestamp(),'yyyy-MM-dd'),TO_DATE(close_gps_time)) = 20
      |or DATEDIFF(from_unixtime(unix_timestamp(),'yyyy-MM-dd'),TO_DATE(close_gps_time)) = 21
      |or DATEDIFF(from_unixtime(unix_timestamp(),'yyyy-MM-dd'),TO_DATE(begin_time)) = 21
      |or DATEDIFF(from_unixtime(unix_timestamp(),'yyyy-MM-dd'),TO_DATE(begin_time)) = 22
    """.stripMargin
  ...
  lazy val driver_online_record_yesterday =
    """
      ...
      |driver_id ,
      |time,
      |time - UNIX_TIMESTAMP(date_sub(from_unixtime(unix_timestamp(),'yyyy-MM-dd'),21),'yyyy-MM-dd') as online_time
      |from
      |driver_online_record_time_rank
      |where rank = 1
      |and state = 0
  ...
  lazy val driver_online_record_nextday =
    """
      ...
      |driver_id ,
      |time,
      |UNIX_TIMESTAMP(date_sub(from_unixtime(unix_timestamp(),'yyyy-MM-dd'),20),'yyyy-MM-dd') - time as online_time
      |from
...
//    """.stripMargin
  ...
  lazy val order_info_sameday =
    """
      ...
      |from
      |order_info_filter
      |where DATEDIFF(from_unixtime(unix_timestamp(),'yyyy-MM-dd'),close_gps_time) = 21
      |and DATEDIFF(from_unixtime(unix_timestamp(),'yyyy-MM-dd'),begin_time) = 21
  ...
  lazy val order_info_yesterday =
    """
      |select
      |driver_id,
      |close_gps_time_s - UNIX_TIMESTAMP(date_sub(from_unixtime(unix_timestamp(),'yyyy-MM-dd'),21),'yyyy-MM-dd') as online_time
      |from
      |order_info_filter
      |where DATEDIFF(from_unixtime(unix_timestamp(),'yyyy-MM-dd'),close_gps_time) = 21
      |and DATEDIFF(from_unixtime(unix_timestamp(),'yyyy-MM-dd'),begin_time) = 22
    """.stripMargin
  ...
  lazy val order_info_nextday =
    """
      |select
      |driver_id,
      |UNIX_TIMESTAMP(date_sub(from_unixtime(unix_timestamp(),'yyyy-MM-dd'),20),'yyyy-MM-dd') - begin_time_s as online_time
      |from
      |order_info_filter
      |where DATEDIFF(from_unixtime(unix_timestamp(),'yyyy-MM-dd'),close_gps_time) = 20
      |and DATEDIFF(from_unixtime(unix_timestamp(),'yyyy-MM-dd'),begin_time) = 21
    """.stripMargin
  ...
  lazy val order_info_oneday_group1 =
    """
      ...
      |driver_company_id,
      |driver_company_name,
      |date_sub(from_unixtime(unix_timestamp(),'yyyy-MM-dd'),21) online_date,
